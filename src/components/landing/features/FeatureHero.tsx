      ...
      <section className="relative bg-linear-to-b from-white via-blue-50/30 to-white py-20 md:py-32 overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto mb-12 leading-relaxed animate-slide-up animation-delay-200">
            From creating estimates to tracking every Naira, Invoiss gives you
            the tools to look professional and get paid faster.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16 animate-slide-up animation-delay-400">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 bg-white hover:bg-gray-50 text-gray-700 font-semibold px-8 py-4 rounded-xl border-2 border-gray-200 hover:border-gray-300 transition-all duration-300 shadow-sm hover:shadow-md"
            >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 p-4 animate-fade-in">
          <div className="relative w-full max-w-5xl">
            ...
            <div className="relative bg-black rounded-xl overflow-hidden shadow-2xl">
              <video
                src="https://res.cloudinary.com/dvhbcih9v/video/upload/v1763085865/Invoiss_Demo_e6h9lh.mov"
                controls
                autoPlay
                className="w-full h-auto"
              >
