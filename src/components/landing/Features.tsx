...
export function Features() {
  return (
    <section
      id="features"
      className="relative bg-linear-to-b from-gray-50 via-white to-gray-50 py-20 md:py-32 overflow-hidden"
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {features.map((feature, index) => (
            <Card
              key={index}
              className="group relative border-0 shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden bg-white hover:-translate-y-2 animate-in fade-in slide-in-from-bottom-8"
            ...
            >
              ...
              <CardHeader className="relative z-10 p-8">
                <div className="relative mb-6">
                  <div
                    className={`absolute inset-0 bg-linear-to-br ${feature.gradient} rounded-2xl blur-xl opacity-20 group-hover:opacity-40 transition-opacity duration-500`}
                  />
                  <div
                ...
                <div className="flex items-center gap-2 text-sm font-semibold bg-linear-to-r from-[#1451cb] to-purple-600 bg-clip-text text-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500">
              ...
              <div
                className={`absolute top-0 right-0 w-32 h-32 bg-linear-to-br ${feature.gradient} rounded-full blur-3xl opacity-0 group-hover:opacity-20 transition-opacity duration-500 -translate-y-16 translate-x-16`}
              />
            </Card>
          ))}
        </div>
